 ...
 * Aktualizace: Zachována podpora JBL Quantum + přidána ÚSPORA ENERGIE + FULL CONSOLE LOGY + USB DONGLE KATEGORIE
 */
...
(function() {
    ...
    // =========================================================================
    // 🎛️ GLOBÁLNÍ PŘEPÍNAČ LOGOVÁNÍ (platí jen v tomto modulu)
    // =========================================================================
    const DEBUG_MODE = false;  // true = LOGY ZAPNUTY | false = LOGY VYPNUTY
